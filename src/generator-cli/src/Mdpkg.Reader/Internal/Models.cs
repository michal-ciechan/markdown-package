...
internal sealed record Manifest(string Mdpkg, string Namespace, CurrentState Current,
    AddressingDeclaration Addressing, PackageHistory History, JsonObject? Review = null);
...
internal sealed record HistoryDetail(string Walk, string Root, string SourceBase, string SourceTip,
    ...
    string? SourceRepository = null, string? Scope = null, string? Bindings = null, JsonObject? Origin = null);
