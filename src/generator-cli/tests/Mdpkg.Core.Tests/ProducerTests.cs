...
public class ProducerTests
{
    ...
    public async Task SparseCorrespondenceAndReservedBirthAreTrackedAndValidated()
    {
        ...
        var oldRoot = Inventory.Root(EngineFixture.Namespace, locator);
    ...
    public async Task UnknownCorrespondenceSetsPartialAndUnconfirmedCandidateIsRejected()
    {
        ...
        File.WriteAllText(records, "[{\"root\":\"" + EngineFixture.RootId + "\",\"unknown\":\"unconfirmed-removal\"}]");
        ...
        File.WriteAllText(records, "[{\"root\":\"" + EngineFixture.RootId + "\",\"confirmed\":false,\"to\":[\"document\",\"x.md\",[]]}]");
